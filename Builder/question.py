...
class Question:
    ...
    def get_answers():
        ...
        quests: List[Union[QuestionCheckbox, QuestionList]] = [
            ...
            QuestionList(
                name="install_grub",
                message="2) Install and configure GRUB (operating system loader)?",
                choices=["Yes", "No"],
                default="Yes",
                carousel=True,
            ),
            QuestionList(
                name="install_plymouth",
                message="3) Install and configure Plymouth (Screen displayed during bootup)?",
                choices=["Yes", "No"],
                default="Yes",
                carousel=True,
            ),
        ...
        return BuildOptions(
            ...
            install_plymouth=answers["install_plymouth"] == "Yes",
